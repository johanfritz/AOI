...
\begin{document}
	...
	% TODO: Add 1-2 sentences stating your project goal (e.g., reproducing their ray paths from reanalysis data)
	...
	\subsection{Data}
	\begin{itemize}
		\item Source: ERA5 reanalysis (ECMWF)
		\item Variables: Zonal wind $U$ at 300 hPa
		\item Time period: December-February climatology (1991-2020)
